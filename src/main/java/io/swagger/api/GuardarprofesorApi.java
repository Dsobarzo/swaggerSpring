...
@Validated
public interface GuardarprofesorApi {

    @Operation(summary = "Agrega un Profesor a la base de datos.", description = "Peticion de tipo POST al EndPoint, para agregar un profesor a la base de Datos.", tags={ "Profesores" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "(OK) La informacion se entrego correctamente.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ExitoProfesorPost.class))),
    ...
    ResponseEntity<ExitoProfesorPost> guardarProfesor_(@Parameter(in = ParameterIn.DEFAULT, description = "Agregar Profesor.", required=true, schema=@Schema()) @Valid @RequestBody BodyProfesorPost body);

...
@Validated
public interface ObtenerprofesoresApi {

    @Operation(summary = "Consulta a la base de datos todos los proefesores existentes en ella.", description = "Peticion del cliente a la api para obtener todos los clientes en la base de datos.", tags={ "Profesores" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/obtenerprofesores",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ExitoProfesorPost> listasProfesores_();

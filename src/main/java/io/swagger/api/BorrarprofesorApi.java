...
@Validated
public interface BorrarprofesorApi {

    @Operation(summary = "Elimina un profesor existente", description = "", tags={ "Profesores" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/borrarprofesor/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<ExitoProfesorModificar> borrarprofesorIdDelete(@Parameter(in = ParameterIn.PATH, description = "ID del profesor a eliminar", required=true, schema=@Schema()) @PathVariable("id") BigDecimal id);
